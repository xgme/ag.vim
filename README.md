...
This plugin supports default directory for searches when user doesn't explicitly provides the directory. Use following in you .vimrc to set your default search directory:
